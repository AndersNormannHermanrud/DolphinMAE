...
class FbankProcessor:
    def __init__(self, sample_rate=None, n_mels=128, n_fft=1024, win_len_ms=25, hop_len_ms=10):
        """
...
class AudioIterableDataset(IterableDataset):
    def __init__(self, file_paths, transform=None, shuffle=False):
        ...
        self.fbank_processor = FbankProcessor(sample_rate=None, n_mels=n_mels, n_fft=n_fft, win_len_ms=win_len_ms,

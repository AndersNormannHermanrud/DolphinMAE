...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))) #This is here for some weird IDUN error, you can probably delete this
os.environ["KMP_DUPLICATE_LIB_OK"] = "TRUE" # Please remove this if able
...
def main():
    ...
    path = "/cluster/projects/uasc/anders/ssast_pretraining/results/Final_Pretraining/pretrained_best-v1.ckpt"
